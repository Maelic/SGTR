...
_config_dict = dict(
    DEBUG=False,
    EXPERIMENT_NAME="detr_vg_indoor_from_imagenet_with_norm",
    MODEL=dict(
        WEIGHTS="detectron2://ImageNetPretrained/MSRA/R-101.pkl",
        # PIXEL_STD=[57.375, 57.120, 58.395],
        PIXEL_STD=[1.0,1.0,1.0],
        PIXEL_MEAN=[103.530, 116.280, 123.675], # detectron2 pixel normalization config
        # WEIGHTS="/group/rongjie/output/cvpods/playground/detection/coco/detr/detr.res101.c5.coco.multiscale.150e.bs16/2021-01-18_11-32-detr_coco/model_0342054.pth",
